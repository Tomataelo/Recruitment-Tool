...
class getJobOfferRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Repository\\JobOfferRepository'])) {
            return $container->privates['App\\Repository\\JobOfferRepository'];
        }

        $instance = new \App\Repository\JobOfferRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), $a);

        if (isset($container->privates['App\\Repository\\JobOfferRepository'])) {
            return $container->privates['App\\Repository\\JobOfferRepository'];
        }

        return $container->privates['App\\Repository\\JobOfferRepository'] = $instance;
    }
}
