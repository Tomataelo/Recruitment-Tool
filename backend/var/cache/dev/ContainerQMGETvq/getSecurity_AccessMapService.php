...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\ChainRequestMatcher([new \Symfony\Component\HttpFoundation\RequestMatcher\PathRequestMatcher('^/api/search')]), ['IS_AUTHENTICATED_FULLY'], NULL);
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\ChainRequestMatcher([new \Symfony\Component\HttpFoundation\RequestMatcher\MethodRequestMatcher(['GET']), new \Symfony\Component\HttpFoundation\RequestMatcher\PathRequestMatcher('^/api/job-offers')]), ['PUBLIC_ACCESS'], NULL);
