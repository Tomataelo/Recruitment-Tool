...
class getCandidateRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Repository\\CandidateRepository'])) {
            return $container->privates['App\\Repository\\CandidateRepository'];
        }

        $instance = new \App\Repository\CandidateRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), $a);

        if (isset($container->privates['App\\Repository\\CandidateRepository'])) {
            return $container->privates['App\\Repository\\CandidateRepository'];
        }

        return $container->privates['App\\Repository\\CandidateRepository'] = $instance;
    }
}
