...
class getUserRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \App\Repository\UserRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), $a);

        if (isset($container->privates['App\\Repository\\UserRepository'])) {
            return $container->privates['App\\Repository\\UserRepository'];
        }

        return $container->privates['App\\Repository\\UserRepository'] = $instance;
    }
}
